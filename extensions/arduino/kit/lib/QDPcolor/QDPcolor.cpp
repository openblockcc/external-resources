 ...
 *  @param  value
 */
void QDPcolor::write8(uint8_t reg, uint32_t value) {
 ...
 *  @return value
 */
uint8_t QDPcolor::read8(uint8_t reg) {
  _wire->beginTransmission(_i2caddr);
#if ARDUINO >= 100
  _wire->write(TCS34725_COMMAND_BIT | reg);
#else
 ...
 *  @return value
 */
uint16_t QDPcolor::read16(uint8_t reg) {
  uint16_t x;
  uint16_t t;
 ...
 *          Gain
 */
QDPcolor::QDPcolor(tcs34725IntegrationTime_t it,
                                     tcs34725Gain_t gain) {
 ...
 */
boolean QDPcolor::begin(uint8_t addr) {
  _i2caddr = addr;
  _wire = &Wire;
 ...
 *  @return True if initialization was successful, otherwise false.
 */
boolean QDPcolor::begin(uint8_t addr, TwoWire *theWire) {
  _i2caddr = addr;
  _wire = theWire;
 ...
 *          Integration Time
 */
void QDPcolor::setIntegrationTime(tcs34725IntegrationTime_t it) {
 ...
 */
void QDPcolor::setGain(tcs34725Gain_t gain) {
  if (!_tcs34725Initialised)
    begin();
 ...
 *          Clear channel value
 */
void QDPcolor::getRawData(uint16_t *r, uint16_t *g, uint16_t *b,
                                   uint16_t *c) {
  if (!_tcs34725Initialised)
    begin();
 ...
 *          Clear channel value
 */
void QDPcolor::getRawDataOneShot(uint16_t *r, uint16_t *g, uint16_t *b,
                                          uint16_t *c) {
  if (!_tcs34725Initialised)
    begin();
 ...
 */
void QDPcolor::getRGB(float *r, float *g, float *b) {
 ...
 */
uint16_t QDPcolor::calculateColorTemperature(uint16_t r, uint16_t g,
                                                      uint16_t b) {
 ...
 *  @return Color temperature in degrees Kelvin
 */
uint16_t QDPcolor::calculateColorTemperature_dn40(uint16_t r,
                                                           uint16_t g,
                                                           uint16_t b,
                                                           uint16_t c) {
 ...
 *  @return Lux value
 */
uint16_t QDPcolor::calculateLux(uint16_t r, uint16_t g, uint16_t b) {
  float illuminance;
 ...
 */
void QDPcolor::setInterrupt(boolean i) {
 ...
 *          High limit
 */
void QDPcolor::setIntLimits(uint16_t low, uint16_t high) {
