/*
  TM1637 - class to control a 4 digit seven segment display with a TM1636 or TM1637 driver IC
...
class TM1637 : public Print {
  ...
  public:
    ...
    */
    ...
    // TM1637 low level methods (use when you know what you're doing)
